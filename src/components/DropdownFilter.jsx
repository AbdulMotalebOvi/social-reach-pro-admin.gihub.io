          ...
          <ul className="mb-4">
            <li className="py-1 px-3">
              <label className="flex items-center">
                ...
                <span className="text-sm font-medium ml-2">Users</span>
              </label>
            </li>
            <li className="py-1 px-3">
              <label className="flex items-center">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm font-medium ml-2">Managers</span>
              </label>
            </li>
            <li className="py-1 px-3">
              <label className="flex items-center">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm font-medium ml-2">Plans</span>
              </label>
            </li>
